...
// Fix: Import MotionProps for explicit typing of animation props.
...
const WardrobeModal: React.FC<WardrobeModalProps> = ({ isOpen, onClose, onGarmentSelect, activeGarmentIds, isLoading }) => {
  ...
  // Fix: Define animation props in MotionProps typed objects to fix type errors.
  ...
  return (
    <AnimatePresence>
        {isOpen && (
            <motion.div
                // Fix: Spread the motion props object here.
                {...backdropAnimation}
                onClick={onClose}
